...
export default function App() {
  ...
  const updateSaunaText = (id: number, text: string) => {
    setSaunaState(saunaState.map(s => s.id === id  ? ({...s, text}): s))
  }
  ...
  return (
    ...
    <ToolBar addNewSauna={addNewSauna}/>
      ...
      <SideBar sauna={saunaState} selectedSaunaID={selectedSaunaID} setSelectedSaunaID={setSelectedSaunaID} deleteSauna={deleteSauna} />
      <SaunaView sauna={saunaState} selectedSaunaID={selectedSaunaID} updateSaunaText={updateSaunaText}/> 
